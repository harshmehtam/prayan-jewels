...
// ImagePlaceholder component moved outside
...
// Mobile Carousel component moved outside
        ...
        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
          {images.map((_, index) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition-all duration-200 ${selectedImageIndex === index ? 'bg-white' : 'bg-white/50'
                }`}
            />
          ))}
        </div>
...
// Desktop Grid component moved outside
const DesktopGrid = ({
  images,
  productName,
  imageError,
