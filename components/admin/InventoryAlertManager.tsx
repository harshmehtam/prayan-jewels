// COMMENTED OUT - Inventory alert manager component - Not needed for now since inventory models are disabled
/*
'use client';
...
export default function InventoryAlertManager({ onClose }: { onClose: () => void }) {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
        <div className="text-center">
          <h2 className="text-xl font-semibold text-gray-600 mb-4">Inventory Alerts</h2>
