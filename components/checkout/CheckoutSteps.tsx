            ...
            <li key={step.id} className={`relative ${stepIdx !== steps.length - 1 ? 'pr-4 sm:pr-8 lg:pr-20' : ''} flex-1 max-w-xs`}>
              ...
              <div className="relative flex flex-col items-center">
                {isCompleted ? (
                  ...
                  <div className="h-6 w-6 sm:h-8 sm:w-8 rounded-full border-2 border-blue-600 bg-white flex items-center justify-center">
                    <div className="h-2 w-2 sm:h-2.5 sm:w-2.5 rounded-full bg-blue-600" />
                  </div>
                ) : (
